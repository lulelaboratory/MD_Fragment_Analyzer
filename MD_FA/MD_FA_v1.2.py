...
# --------------------------
# GUI Class using Tkinter (Revised Layout with GPU, PBC, and Radii Options)
# --------------------------
class FragmentCounterGUI:
    def __init__(self, master):
        ...
        self.radius_type = tk.StringVar(value="Covalent Radii")  # new variable
    ...
    def run_counting(self):
        ...
        # Determine radii type from dropdown selection:
